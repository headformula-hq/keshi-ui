 ...
 */
export declare const FIELD_CLASS = "rounded-xl border border-line/60 bg-transparent p-2.5 text-[13.5px] text-ink outline-none focus:border-brand/50 disabled:opacity-50";
